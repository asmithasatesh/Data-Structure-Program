...
namespace DataStructurePrograms
{
    class OrderedList<T>
    {
        ...
        public void GetInput()
        {
            ...
            myFile = File.ReadAllText(@"D:\Assignments\DataStructurePrograms\DataStructurePrograms\NumberList.txt").Split(" ");
            ...
            File.WriteAllText(@"D:\Assignments\DataStructurePrograms\DataStructurePrograms\NumberList.txt", StringValues);
        }
    }
}
